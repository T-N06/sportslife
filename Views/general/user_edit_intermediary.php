...
<html lang="en" dir="ltr">
  ...
  <body id="create">
    ...
    <div class="create_content">
      <form class="create_form" action="user_edit_complete.php" method="post">
        <h2>新規登録</h2>
        <dl class="">
        ...
        <div class="create_btn">
          <input class="create_submit" type="submit" name="create_btn" onclick="return confirm('編集してもよろしいですか？')"　value="送信">
          <input class="create_submit" type="button" onclick="location.href='user_edit.php'" value="キャンセル">
        </div>
      </form>
    </div>
  </body>
