      ...
      <div class="mypage_main">
        <div class="mypage_status">
          ...
          <table>
            ...
            <tr>
              <th>内容</th>
              <td><?=h($params['plan']['plan_text'])?></td>
            </tr>
            <tr class="flg">
              <th>備考</th>
              <td><?=h($params['plan']['remarks'])?></td>
            </tr>
          </table>
          <div class="event_btn">
            <button class="btn" type="button" name="button" onclick="location.href='chat.php?id=<?php echo $_GET['id']; ?>'">Chat</button>
            <button class="btn" type="button" name="button" onclick="location.href='take_intermediary.php?id=<?php echo $_GET['id']; ?>'">参加</button>
          </div>
        </div>
      </div>
  </body>
